        ...
        <div id="mainContainer">
            ...
            <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                <div id="secondaryToolbarButtonContainer">
                    <button id="secondaryOpenFile" class="secondaryToolbarButton" <?php if ($button_open!=="true") { echo 'style="display:none;"'; } ?> title="Open File" tabindex="51" data-l10n-id="pdfjs-open-file-button">
                        <span data-l10n-id="pdfjs-open-file-button-label">Open</span>
                    </button>

                    <button id="secondaryPrint" class="secondaryToolbarButton visibleMediumView" <?php if ($button_print!=="true") { echo 'style="display:none;"'; }?> title="Print" tabindex="52" data-l10n-id="pdfjs-print-button">
                        <span data-l10n-id="pdfjs-print-button-label">Print</span>
                    </button>

                    <button id="secondaryDownload" class="secondaryToolbarButton visibleMediumView" <?php if ($button_download!=="true") { echo 'style="display:none;"'; } ?> title="Save" tabindex="53" data-l10n-id="pdfjs-save-button">
                ...
                <div id="toolbarContainer">
                  ...
                  <input type="number" id="pageNumber" class="toolbarField" title="Page" value="1" min="1" tabindex="15" data-l10n-id="pdfjs-page-input" autocomplete="off">
                        ...
                        <div id="toolbarViewerRight">
                            ...
                            <button id="print" <?php if ($button_print!=="true") { echo 'style="display:none;"'; }?> class="toolbarButton hiddenMediumView" title="Print" tabindex="41" data-l10n-id="pdfjs-print-button">
                                <span data-l10n-id="pdfjs-print-button-label">Print</span>
                            </button>

                            <button id="download" <?php if ($button_download!=="true") { echo 'style="display:none;"'; } ?> class="toolbarButton hiddenMediumView" title="Save" tabindex="42" data-l10n-id="pdfjs-save-button">
                                <span data-l10n-id="pdfjs-save-button-label">Save</span>
                            </button>
